<div id="myCarousel" class="carousel slide">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <div class="fill" style="background-image:url('<?php echo $assist->view->url("lib/theme/src/client/tpl/debug/img/banner-slide-1.jpg")?>');"></div>
            ...
            <div class="item">
                <div class="fill" style="background-image:url('<?php echo $assist->view->url("lib/theme/src/client/tpl/debug/img/banner-slide-2.jpg")?>');"></div>
                <div class="carousel-caption slide-up">
                    <h1 class="banner_heading">Providing The <span>Highest </span>Lorem</h1>
                    <p class="banner_txt">Lorem ipsum dolor sit amet sit legimus copiosae instructior eiut vix denique fierentis ea saperet inimicu utqui dolor oratio mnesarchum.</p>
                    <div class="slider_btn">
            ...
            <div class="item">
                <div class="fill" style="background-image:url('<?php echo $assist->view->url("lib/theme/src/client/tpl/debug/img/banner-slide-3.jpg")?>');"></div>
                <div class="carousel-caption slide-up">
                    <h1 class="banner_heading">Providing The <span>Highest </span>Lorem</h1>
                    <p class="banner_txt">Lorem ipsum dolor sit amet sit legimus copiosae instructior eiut vix denique fierentis ea saperet inimicu utqui dolor oratio mnesarchum.</p>
                    <div class="slider_btn">
