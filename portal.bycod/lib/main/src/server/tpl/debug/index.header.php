        ...
        <div class="container">
            <div class="row">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?php echo $assist->view->url("main/index"); ?>">
                ...
                <div id="navbar" class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        <li <?php echo $data['active']=="main"?'class="active"':""; ?>><a href="<?php echo $assist->view->url("main/index"); ?>"><?php echo $idiom["main"]['title']; ?></a></li>
