		...
		<div class="demo-gallery">
            <ul id="lightgallery" class="list-unstyled row">
				<?php
					for ($i=1; $i<60; $i++){
						$dtas  = '<li id="im'.$i.'" class="col-xs-6 col-sm-4 col-md-3" style="display:none;" style="display:none;" data-responsive="./images/tips/'.$i.'.png" data-src="./images/tips/'.$i.'.png" data-sub-html="">';
						$dtas .= '<a href=""> <img class="img-responsive"  src="./images/tips/'.$i.'.png">  </a>';
						$dtas .= '</li>';
						echo $dtas;
					}
				?>
